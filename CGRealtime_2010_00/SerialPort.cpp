...
BOOL CSerialPort::InitPort(CWnd* pPortOwner,	// the owner (CWnd) of the port (receives message)
						   ...
						   DWORD  writebuffersize)	// size to the writebuffer
{
...
void CSerialPort::WriteChar(CSerialPort* port)
{
	...
	if (BytesSent != (DWORD)port->m_nToSend)
	{
...
//
void CSerialPort::WriteToPort(BYTE* data,int nLength)
{		
//	assert(m_hComm != 0);
	if(m_hComm==0) 
	{
	...
	memcpy(m_szWriteBuffer, data,nLength);
	m_nToSend=nLength;
